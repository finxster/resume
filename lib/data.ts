...
export const experiences: Experience[] = [
  {
    ...
    code: "AC",
    initial: "AC",
    title: { en: "Senior Software Engineer · Tech Lead · AI", pt: "Engenheiro de Software Sênior · Tech Lead · IA" },
    company: "Avenue Code",
    ...
    progression: [
      {
        years: "2025 – now",
        title: {
          en: "Williams Sonoma · AI Rules Engine",
          pt: "Williams Sonoma · Motor de Regras com IA",
        },
        note: {
      ...
      },
      {
        years: "2024 – 2025",
        title: {
          en: "Williams Sonoma · Tech Evolution & AI",
          pt: "Williams Sonoma · Evolução Técnica & IA",
        },
        note: {
  ...
  },
  {
    ...
    description: {
      en: "Joined Avenue Code as a senior engineer and tech lead. Started with three months on-site in the US at Merchant e-Solutions, working on their AMEX certification, then returned to Brazil for the SquareTrade account — one of the first three engineers, growing the team to 30+. Relocated to the US in 2018: microservices on top of Sterling at Williams Sonoma, then the PIM / Data Governance (Stibo → Kafka) project at GAP.",
      pt: "Entrei na Avenue Code como engenheiro sênior e tech lead. Comecei com três meses on-site nos EUA na Merchant e-Solutions, trabalhando na certificação AMEX, e voltei ao Brasil para a conta da SquareTrade — um dos três primeiros engenheiros, ajudando a crescer o time para mais de 30 pessoas. Mudei para os EUA em 2018: microsserviços sobre o Sterling na Williams Sonoma e depois o projeto de PIM / Data Governance (Stibo → Kafka) na GAP.",
    },
    roles: [R.techLead, R.seniorDeveloper, R.scrumMaster, R.mentor],
    clientPeriods: [
      { client: "Merchant e-Solutions", start: 2015, end: 2016, country: "US" },
      { client: "SquareTrade", start: 2016, end: 2018, country: "BR" },
  ...
  },
  {
    ...
    progression: [
      {
        years: "2013 – 2015",
        title: { en: "Tech Lead · NAVE", pt: "Tech Lead · NAVE" },
        note: {
          en: "Tech lead on NAVE, an asset-management system running on AWS, and on the regulatory features of the investment-fund management product — Kanban reference, business analysis, and mentoring the team.",
          pt: "Tech lead do NAVE, sistema de gestão de ativos rodando na AWS, e das funcionalidades regulatórias do produto de gestão de fundos — referência em Kanban, análise de negócio e mentoria do time.",
        },
      },
      {
        years: "2010 – 2013",
        title: {
          en: "Senior Engineer · Scrum Master · Centaurus",
          pt: "Engenheiro Sênior · Scrum Master · Centaurus",
        },
        note: {
          en: "Control and bookkeeping of investment funds. Designed and developed the tax component at the system's core, wrote test scenarios, did business analysis, and acted as Scrum Master and technical manager.",
          pt: "Controle e escrituração de fundos de investimento. Projetei e desenvolvi o componente de tributação no núcleo do sistema, escrevi cenários de teste, fiz análise de negócio e atuei como Scrum Master e gerente técnico.",
        },
      },
      {
        years: "2007 – 2010",
        title: { en: "Software Engineer · Pegasus", pt: "Engenheiro de Software · Pegasus" },
        note: {
          en: "Custody and controllership of investment funds. Designed and built the tax component and several core features, with JSF on the front end, SVN, Maven, and Jenkins CI.",
          pt: "Custódia e controladoria de fundos de investimento. Projetei e construí o componente de tributação e diversas funcionalidades centrais, com JSF no front-end, SVN, Maven e CI com Jenkins.",
        },
      },
      {
        years: "2005 – 2007",
        title: { en: "Intern → Engineer · TCL / BWPAGee", pt: "Estagiário → Engenheiro · TCL / BWPAGee" },
        note: {
          en: "Started as an intern on TCL, a customer-control system for a major global bank, then moved to BWPAGee, a Brazilian payment-system control product — Java/Hibernate on Oracle, Velocity front end, Ant builds.",
          pt: "Comecei como estagiário no TCL, sistema de controle de clientes para um grande banco global, e depois fui para o BWPAGee, produto de controle do sistema de pagamentos brasileiro — Java/Hibernate sobre Oracle, front-end em Velocity, build com Ant.",
        },
      },
    ],
